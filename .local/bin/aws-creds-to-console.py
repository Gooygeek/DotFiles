...
import boto3
import os
from requests.sessions import session # AWS SDK for Python (Boto3) 'pip install boto3'
...
#     RoleArn="arn:aws:iam::351014352296:role/KGOL-Admin",
...
# sessionId = input("Access Key ID: ")
# sessionKey = input("Secret Access Key: ")
...
if os.getenv("AWS_REGION", "ap-southeast-2")[:2] == "cn":
    request_parameters += "&Destination=" + quote_plus_function("https://console.amazonaws.cn/")
else:
